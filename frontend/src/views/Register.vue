...
<template>
  <h1 class="text-center pt-6 font-bold text-2xl">Register page</h1>
  ...
  <div class="flex items-center justify-center">
    ...
    >
      <h2 class="text-2xl font-bold text-center text-gray-800">Create a user</h2>
      <div v-if="error" class="text-red-500 mb-0">error: {{ error }}</div>

      <div>
        <label class="block mb-1 text-sm font-medium text-gray-700" for="name">Имя</label>
        <input
          id="name"
          type="text"
